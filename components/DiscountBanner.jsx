...
const DiscountBanner = () => {
  ...
  return (
    <div className="bg-slate-800 lg:mx-auto lg:max-w-5xl xl:max-w-6xl -mt-28 relative mx-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12  lg:py-10">
        ...
        <div className="text-white p-2 px-5 pr-10 col-span-7 text-center lg:text-left flex flex-col justify-center items-center">
          <h2 className="text-3xl mb-2">Dive into the Ocean of Knowledge</h2>
            <p>Start Your Journey Today with Essay Writing UK. Get a <span className="text-orange-600 font-bold">15% discount</span> on our Writing Services. Hurry up, you get the chance to avail this limited-time offer.</p>
        </div>
        <div className="w-full col-span-2 justify-center items-center flex flex-col">
          ...
          <h3 className="text-orange-600 p-2 font-bold text-lg text-left w-full">Hurry ...</h3>
            ...
            <p className="text-orange-600 font-bold text-lg p-2 text-right">... remaining</p>
