...
const Feedback = () => {
  return (
    <div className="flex flex-col items-center mt-4">
      <h2 className="text-xl sm:text-2xl md:text-3xl border-b-4  border-orange-600 border-r-2 text-center  font-bold p-2 shadow-md">
        Trust is<span className="text-orange-600">&nbsp;our win</span>
      </h2>
      <div className="flex flex-col mt-10 sm:mt-0 lg:flex-row justify-center md:justify-start gap-6">
