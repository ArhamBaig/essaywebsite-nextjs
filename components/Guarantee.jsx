...
export const Guarantee = () => {
  ...
  return (
    <div className="container justify-center items-center mx-auto px-5 sm:px-10 md:px-25  mt-10 p-3">
      ...
      <Slider {...settings}>
        <GuaranteeCard alt="high quality work" name="High-quality work" image={medalicon} desc="Our best essay writing service in UK will provide you with the most effective and high-quality essay writing" />
        <GuaranteeCard alt="no additional price" name="No hidden charges" image={priceicon} desc="We try our best to charge a student as low as possible and mention all the charges up front."  />
        <GuaranteeCard alt="punctuality in work" name="On-time work completion" image={timeicon} desc="We strive on our relationships with students. To mantain that, we never compromise on our punctuality pledge."  />
        <GuaranteeCard alt="follow formating practices" name="Right formatting essays" image={formaticon} desc="Formatting standards for essay writing that academic institutions such as APA, MLA, Chicago, and other university-specific forms." />
        <GuaranteeCard alt="live customer support" name="24/7 customer support" image={customersupporticon} desc="We have 24/7 support available for students. You can talk to our agents on Whatsapp or on the chat provided on this site." />
        <GuaranteeCard alt="no plagiarism" name="100% original and unique work." image={privacyicon} desc="We provide work along with the plagiarism report as a proof that the work is 100% original and plag-free." />
    </Slider>
    </div>
    </div>
  );
