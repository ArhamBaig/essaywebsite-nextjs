...
import { menu, close, arrowUp, arrowdown, logowhite } from "../public/assets";
...
const Navbar = () => {
  ...
  return (
    <div className="w-screen z-40 text-black fixed ">
        <div className="flex justify-between items-center h-[80px] whitespace-nowrap sm:px-16 md:px-20 lg:px-24 xl:px-32 bg-slate-900">
          ...
          <button
              className="xl:flex hidden border-orange-600 border-2 text-orange-600 transition-all
              h-10 p-5 items-center hover:bg-orange-700 hover:text-slate-900 hover:border-none"
            onClick={() => {
        ...
        <div
        className={`dropdown flex justify-center duration-300 text-white w-screen bg-gradient-to-b from-slate-900 from-30% to-slate-700
